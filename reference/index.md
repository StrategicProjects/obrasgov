...
- [`get_projects()`](https://strategicprojects.github.io/obrasgovr/reference/get_projects.md)
  [`obter_projetos()`](https://strategicprojects.github.io/obrasgovr/reference/get_projects.md)
...
- [`get_physical_execution()`](https://strategicprojects.github.io/obrasgovr/reference/get_physical_execution.md)
  [`obter_execucao_fisica()`](https://strategicprojects.github.io/obrasgovr/reference/get_physical_execution.md)
  : Retrieve physical execution data
- [`get_contracts()`](https://strategicprojects.github.io/obrasgovr/reference/get_contracts.md)
  [`obter_contratos()`](https://strategicprojects.github.io/obrasgovr/reference/get_contracts.md)
  : Retrieve contracts
- [`get_commitments()`](https://strategicprojects.github.io/obrasgovr/reference/get_commitments.md)
  [`obter_empenhos()`](https://strategicprojects.github.io/obrasgovr/reference/get_commitments.md)
  : Retrieve budget commitments
- [`get_geometries()`](https://strategicprojects.github.io/obrasgovr/reference/get_geometries.md)
  [`obter_geometrias()`](https://strategicprojects.github.io/obrasgovr/reference/get_geometries.md)
  : Retrieve geometries
- [`get_status_history()`](https://strategicprojects.github.io/obrasgovr/reference/get_status_history.md)
  [`obter_historico_situacao()`](https://strategicprojects.github.io/obrasgovr/reference/get_status_history.md)
...
- [`get_feasibility_studies()`](https://strategicprojects.github.io/obrasgovr/reference/get_feasibility_studies.md)
  [`obter_estudos_viabilidade()`](https://strategicprojects.github.io/obrasgovr/reference/get_feasibility_studies.md)
  : Retrieve feasibility studies
- [`get_last_update()`](https://strategicprojects.github.io/obrasgovr/reference/get_last_update.md)
  [`obter_data_atualizacao()`](https://strategicprojects.github.io/obrasgovr/reference/get_last_update.md)
  : Retrieve the data update timestamp

## Discovery and metadata

Each topic also lists its Portuguese compatibility alias, which shares
the same help page.

- [`list_resources()`](https://strategicprojects.github.io/obrasgovr/reference/list_resources.md)
  [`obrasgov_recursos()`](https://strategicprojects.github.io/obrasgovr/reference/list_resources.md)
  : List available ObrasGov API resources
- [`list_filters()`](https://strategicprojects.github.io/obrasgovr/reference/list_filters.md)
  [`obrasgov_filtros()`](https://strategicprojects.github.io/obrasgovr/reference/list_filters.md)
...
- [`result_metadata()`](https://strategicprojects.github.io/obrasgovr/reference/result_metadata.md)
  [`obrasgov_metadados()`](https://strategicprojects.github.io/obrasgovr/reference/result_metadata.md)
